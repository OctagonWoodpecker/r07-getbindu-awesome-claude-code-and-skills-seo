...
### Derived from [GetBindu/awesome-claude-code-and-skills](https://github.com/GetBindu/awesome-claude-code-and-skills)
...
> **Adaptation of `GetBindu/awesome-claude-code-and-skills` for SEO & Content Marketing use cases.**
> Source focus: _curated skill collection and resource index_
...
```bash
# Clone this skill
cp -r . ~/.claude/skills/r00-GetBindu-awesome-claude-code-and-skills--seo/

# Register in Claude Code
# In a Claude Code session:
/read ~/.claude/skills/r00-GetBindu-awesome-claude-code-and-skills--seo/SKILL.md
```
...
which focuses on: _curated skill collection and resource index_.
